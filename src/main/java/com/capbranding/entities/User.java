...
public class User {
	...
	public User(int userId, String password, String role, Employee employeeUser) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "User [userId=" + userId + ", password=" + password + ", role=" + role + ", employeeUser=" + employeeUser
				+ "]";
	}
}